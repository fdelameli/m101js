...
Suppose you have a collection called _tweets_ whose documents contain information about the _created_at_ time of the tweet and the user's _followers_count_ at the time they issued the tweet. What can you infer from the following _explain_ output?
